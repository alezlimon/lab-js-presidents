...
function countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((totalYears, president) => {
    const yearsInOffice = (president.leftOffice || new Date().getFullYear()) - president.tookOffice;
...
function getAgeAtInauguration(presidentsArr) {
  return presidentsArr.map(president => {
    ...
    return { name: president.name, ageAtInauguration: ageAtInauguration };
...
function getPresidentsBornAfter(presidentsArr, year) { return presidentsArr.filter(president => president.birthYear > year); }
